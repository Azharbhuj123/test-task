        ...
        <div className="max-w-xl w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1.5 max-w-sm mx-auto">
              I can read your campaigns, analyze performance, search guidelines, and request actions with your approval.
            </p>
          </div>
          ...
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider flex items-center gap-1">
              <Sparkles size={10} /> Suggested prompts
            </span>
            <div className="h-px flex-1 bg-gray-200" />
          </div>
    ...
    <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 bg-slate-50">
      ...
      {isLoading && (
        <div className="flex justify-start mb-5">
          <div className="mr-2.5 flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600">
